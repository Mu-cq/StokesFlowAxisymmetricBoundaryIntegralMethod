...
function [a,b]=boundaries_narrow_large(PARAM)
     ...
     %build bubble interface at the first iteration
     [a(n+m+j+2:n+m+j+q+2),b(n+m+j+2:n+m+j+q+2)] = draw_bubble(2,0,q,D,PARAM.R*PARAM.alpha);
