...
function [x,y] = spherePlus2LegendreCurvilinearAsymmetric(t,delta1,delta2,PARAM)
...
%draw
xfun = @(f0) (f0+delta1*P2+delta2*P3).*cos(pi*t);
yfun = @(f0) (f0+delta1*P2+delta2*P3).*sin(pi*t);
