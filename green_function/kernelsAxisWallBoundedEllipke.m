...
...
  = kernelsAxisWallBoundedEllipke(X,Y,X0,Y0,wallPos)
    ...
    error('BUG')
        ...
        [MdXX,MdXY,MdYX,MdYY,QdXXX,QdXXY,QdXYX,QdXYY,QdYXX,QdYXY,QdYYX,QdYYY,...
            ...
            kernelsAxisDipolesAndDoubletEllipke (X,Y,X0im,Y0);
