function [SXX,SXY,SYX,SYY ...
         ...
         ,Iaxis] ...
 ...
  = sgf_ax_w_ellipke (Iopt,X,Y,X0,Y0,wall)
...
%       PREP = ( 2.0*(2.0-RK2)*E - RK2P*RK2P*F ) / 3.0;
%       RL58 = - (PREP - RL50 + 4.0*RK2*RL52 - 6.0*RK4*RL54 ...
%                             + 4.0*RK6*RL56 ) / RK8;
        FCTR = RK5/(8.0D0*YY5);
        RJ50 = FCTR * RL50;
        ...
        RJ53 = FCTR * (8.0D0*RL56 - 12.0D0*RL54 ...
                      +6.0D0*RL52 - RL50);
%       RJ54 = FCTR * (16.0D0*RL58 - 32.0D0*RL56 + 24.0D0*RL54 ...
%                      -8.0D0*RL52 + RL50);
