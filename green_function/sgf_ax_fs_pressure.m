function [PX,PY,PIXX,PIXY,PIYX,PIYY] = sgf_ax_fs_pressure (X,Y,X0,Y0)

%PX and PY are the pressure in (X0,Y0) associated to a Stokeslet placed in (X,Y)

%PIXX, PIXY, PIYX, PIYY, are the pressure in (X0,Y0) associated with a
%Stresslet in (X0,Y0)
