...
function [xxx,Xsing,Ysing,nnx,nny,nnn] = BEM_2dStokesV2(x,y,PARAM)

  error('Not good developement')
  ...
  [GXX,GXY,GYX,GYY,A11,A12,A21,A22] = computeKernelsOperators2d(Xsing,Ysing,nnn,x,y,PARAM);
  
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  
  %compute influence matrix and known term
  [A,b,nnx,nny] = buildInfluenceMatrixAndKnownTerm2d(GXX,GXY,GYX,GYY,A11,A12,A21,A22,Xsing,nnn,x,y,PARAM);
  ...
  xxx = groupSolutionByPanel(xxx,nnn);
