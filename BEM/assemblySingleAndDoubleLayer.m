...
function [SL,DL,SLpressure,DLpressure,fBC,uBC] = assemblySingleAndDoubleLayer(solution,GXX,GXY,GYX,GYY,A11,A12,A21,A22,PX,PY,PI1,PI2,Xsing,nnn,x,y,PARAM)
...
for i = 1:numel(PARAM.n)
      ...
      if (PARAM.typeBCstokes(i)==1||PARAM.typeBCstokes(i)==2||PARAM.typeBCstokes(i)==3||PARAM.typeBCstokes(i)==4)
      ...
      if PARAM.typeBC(i)==1 || PARAM.typeBC(i)==3    % prescribe velocity, stresses are from the result
      ...
      elseif PARAM.typeBC==2    % prescribe stresses, velocity are from the solution
      ...
      elseif PARAM.typeBC==5    % prescribe normal velocity and tangent stress
