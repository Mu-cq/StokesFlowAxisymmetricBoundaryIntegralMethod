...
function [GXX,GXY,GYX,GYY,A11,A12,A21,A22] = computeKernelsOperators2d(Xsing,Ysing,nnn,x,y,PARAM)
  ...
  if PARAM.cfunction == 0   %compute with MATLAB
        ...
        for i = 1:numel(PARAM.n)
            ...
            if PARAM.orderVariable(i)==0 && PARAM.orderGeometry(i)==0   % integration on constant, straight element
                ...
                %compute Kernels
                [GXX{i},GXY{i},GYX{i},GYY{i},A11{i},A12{i},A21{i},A22{i}] = computeKernelStokesConst2d(x{i},y{i},Xsing,Ysing,startMatrix,sum(nnn(1:i)),PARAM.STstokes);
            ...
            elseif PARAM.orderVariable(i)==1 && PARAM.orderGeometry(i)==0     % integration on linear, straight element
                ...
                %compute Kernels
                [GXX{i},GXY{i},GYX{i},GYY{i},A11{i},A12{i},A21{i},A22{i}] = computeKernelStokesAxisLinear(x{i},y{i},Xsing,Ysing,startMatrix,sum(nnn(1:i)),PARAM.STstokes);
            ...
            elseif PARAM.orderVariable(i)==0 && PARAM.orderGeometry(i)==1     % integration on constant, curved element
                ...
                %compute Kernels
                [GXX{i},GXY{i},GYX{i},GYY{i},A11{i},A12{i},A21{i},A22{i}] = computeKernelStokesAxisConstSpline(Xsing,Ysing,startMatrix,sum(nnn(1:i)),PARAM.STstokes,ax,ay,bx,by,cx,cy,dx,dy);
            ...
            elseif PARAM.orderVariable(i)==1 && PARAM.orderGeometry(i)==1     % integration on linear, curved element
                ...
                %compute Kernels
                [GXX{i},GXY{i},GYX{i},GYY{i},A11{i},A12{i},A21{i},A22{i}] = computeKernelStokesAxisLinearSpline(Xsing,Ysing,startMatrix,sum(nnn(1:i)),PARAM.STstokes,ax,ay,bx,by,cx,cy,dx,dy);
