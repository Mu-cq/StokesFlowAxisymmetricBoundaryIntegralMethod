...
function [GXX,GXY,GYX,GYY,A11,A12,A21,A22,PX,PY,PI1,PI2] = computeKernelsOperatorsAxisVisu(Xsing,Ysing,x,y,PARAM)
...
for i = 1:numel(PARAM.n)
            ...
            if PARAM.orderVariable(i)==0 && PARAM.orderGeometry(i)==0   % integration on constant, straight element
                ...
                %compute with MATLAB
                [GXX{i},GXY{i},GYX{i},GYY{i},A11{i},A12{i},A21{i},A22{i}] = computeKernelStokesAxisConstNoSing(x{i},y{i},Xsing,Ysing,PARAM.kernelFreeSpace,PARAM.posWall);
                [PX{i},PY{i},PI1{i},PI2{i}] = computeKernelPressureStokesAxisConst(x{i},y{i},Xsing,Ysing);
        
            elseif PARAM.orderVariable(i)==1 && PARAM.orderGeometry(i)==0     % integration on linear, straight element

                [GXX{i},GXY{i},GYX{i},GYY{i},A11{i},A12{i},A21{i},A22{i}] = computeKernelStokesAxisLinearNoSing(x{i},y{i},Xsing,Ysing,PARAM.kernelFreeSpace,PARAM.posWall);
            ...
            elseif PARAM.orderVariable(i)==0 && PARAM.orderGeometry(i)==1     % integration on constant, curved element
                ...
                %compute kernels
                [GXX{i},GXY{i},GYX{i},GYY{i},A11{i},A12{i},A21{i},A22{i}] = computeKernelStokesAxisConstSplineNoSing(Xsing,Ysing,ax,ay,bx,by,cx,cy,dx,dy,PARAM.kernelFreeSpace,PARAM.posWall);
            ...
            elseif PARAM.orderVariable(i)==1 && PARAM.orderGeometry(i)==1     % integration on linear, curved element
                ...
                %compute kernels
                [GXX{i},GXY{i},GYX{i},GYY{i},A11{i},A12{i},A21{i},A22{i}] = computeKernelStokesAxisLinearSplineNoSing(Xsing,Ysing,ax,ay,bx,by,cx,cy,dx,dy,PARAM.kernelFreeSpace,PARAM.posWall);
