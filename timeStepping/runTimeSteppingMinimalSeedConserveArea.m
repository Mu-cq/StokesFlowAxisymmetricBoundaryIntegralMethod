...
function [AreaAtTimeHorizon,T,Y] = runTimeSteppingMinimalSeedConserveArea(perturb,xBase,yBase,Tsave,maxDT,initialDT,PARAM,V0,A0)

%initial condition
[xGrid,yGrid] = getVolumeAndAreaConservingShapeSpectral(perturb,xBase,yBase,V0,A0,PARAM);
...
AreaAtTimeHorizon = -surfaceCurvilinearAxisSpectral(xGrid,yGrid,PARAM);
