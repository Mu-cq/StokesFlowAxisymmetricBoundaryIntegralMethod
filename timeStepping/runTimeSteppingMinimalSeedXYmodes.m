...
function [Aperturb,T,Y] = runTimeSteppingMinimalSeedXYmodes(xyMode,Tsave,maxDT,initialDT,PARAM,V0,Abase)

%initial condition
initial = xyMode;

figure(100)
[xGrid,yGrid] = fromModesToGrid(initial(1:2:end-1),initial(2:2:end),PARAM);
plot(xGrid,yGrid)
hold on
axis equal
drawnow
