...
function [AreaAtTimeHorizon,T,Y] = runTimeSteppingMinimalSeed(perturb,xBase,yBase,Tsave,maxDT,initialDT,PARAM,V0)

%initial condition
[xGrid,yGrid] = getVolumeConservingShapeSpectral(perturb,xBase,yBase,V0,PARAM);
