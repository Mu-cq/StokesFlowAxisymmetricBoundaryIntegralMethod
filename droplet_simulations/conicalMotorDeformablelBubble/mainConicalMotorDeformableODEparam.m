...
function mainConicalMotorDeformableODEparam(thetaCone,Ca,nDrop,dt,alpha,xStart,Tend,repInt,repDist,res)
...
%thetaCone = 5;             % inclinitation of the cone
PARAM.visc(5) = 0;
PARAM.D(5) = 0;
%Ca = 0.1;
%alpha = 1;
...
PARAM.x0_Circle = [nan 0 nan L xStart];
...
PARAM.repulsiveOn = repDist;
PARAM.coeffRepulsive = repInt;
