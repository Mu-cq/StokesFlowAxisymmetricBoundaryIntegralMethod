...
function main_ConicalMotorCambridgeTwoBubblesParamODE(dt,tol,ODE,thetaCone,BN,bubbleCycles,results)
...
for i = 1:bubbleCycles
    ...
    if nBubble==1
        ...
        outFun = @(t,var,flag) eventBlocksODE(t,var,flag,tParametricBase,f1bubble,beta,Hcc,PARAM);
