...
function uDropFrame = NormalVelocityRisingSpectralVolumeCM(theta,r,V0,CM,Replace1,thetaReplace1,Replace2,thetaReplace2,PARAM)
    ...
    %compute solution
    [y,N] = bemSpectralRisingTheta(theta,r,PARAM);
