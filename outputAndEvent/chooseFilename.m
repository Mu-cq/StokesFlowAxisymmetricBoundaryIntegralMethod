...
function filename = chooseFilename(PARAM,maxDT,Tend,A0)
...
elseif PARAM.algorithm==6
    filename = ['minimalSeedSpectralXYmodes_n=' num2str(PARAM.dealiasing) '_Ca=' num2str(PARAM.Ca) '_visc=' num2str(PARAM.visc) '_Legendre=' num2str(PARAM.legendre) '_BC=' num2str(PARAM.BC) '_T=' num2str(Tend) '_A0=' num2str(A0) '.mat'];
else
