...
void Stokes2DAxisSPlinesLinearOnlySingle(double *aax, double *bbx, double *ccx, double *ddx, double *aay, double *bby, double *ccy, double *ddy, double *x0, double *y0, double *GXX, double *GXY, double *GYX, double *GYY, int field, int elem)
{
  ...
  double *GXXa, *GXYa, *GYXa, *GYYa;
  double *GXXb, *GXYb, *GYXb, *GYYb;
...
Stokes2DAxisSPlinesLinearOnlySingle(ax, bx, cx, dx, ay, by, cy, dy, inMatrixX0, inMatrixY0, GXX, GXY, GYX, GYY, ncols, nrows-1);
}
