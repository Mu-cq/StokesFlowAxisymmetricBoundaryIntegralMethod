//
//  axisKernelSingleLayerParallel.c
//  
//
...
void axisKernelSingleLayerParallel(double *x, double *y, double *x0, double *y0, double *SXX, double *SXY, double *SYX, double *SYY, int field, int elem, int nnn)
{
  int i, j, axis;
  double xHere, yHere;
  ...
  #pragma omp parallel for private(xHere, yHere, axis, DX, DY, d2, d, r0, r, k2, k, r2, DX2, F, E, G, B, D, C, I10, I11, I30, I31, I32)
  for (j=0; j<elem; j++) {  
...
axisKernelSingleLayerParallel(inMatrixX, inMatrixY, inMatrixX0, inMatrixY0, SXX, SXY, SYX, SYY, ncols, nrows, n);
}
